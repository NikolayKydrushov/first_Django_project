...
class Product(models.Model):
    ...
    picture = models.ImageField(upload_to= 'photos/', blank=True, null=True, verbose_name='фотография')
    category = models.ForeignKey("Category", on_delete=models.SET_NULL, verbose_name='наименование', null=True, blank=True, related_name='products')
